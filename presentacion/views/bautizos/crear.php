...
<div class="container">
    <section class="content-section">
        <div class="content-header">
            <h2 class="content-title">Registrar Nuevo Bautizo</h2>
        ...
        <form action="/bautizos/crear" method="POST" class="form-container">
            ...
            <div class="form-group">
                ...
                <input type="date" name="fecha" id="fecha" class="form-control <?php echo isset($errores['fecha']) ? 'is-invalid' : ''; ?>" value="<?php echo isset($_POST['fecha']) ? htmlspecialchars($_POST['fecha']) : ''; ?>" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="lugar" id="lugar" class="form-control" value="<?php echo isset($_POST['lugar']) ? htmlspecialchars($_POST['lugar']) : ''; ?>" placeholder="Ej: Río Jordan, Templo Central, etc.">
            </div>

            <div class="form-group">
                <label for="pastor">Pastor Oficiante:</label>
                <input type="text" name="pastor" id="pastor" class="form-control" value="<?php echo isset($_POST['pastor']) ? htmlspecialchars($_POST['pastor']) : ''; ?>" placeholder="Nombre del pastor que realizó el bautizo">
            </div>
